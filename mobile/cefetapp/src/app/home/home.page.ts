...
export class HomePage {
  ...
  public schedule = [
    { name: 'CSG20', class: 'S71', room: 'B-107', day : WeekDay.Qua, slot: Slot.M3 },
    { name: 'CSG20', class: 'S71', room: 'B-107', day : WeekDay.Qua, slot: Slot.M4 },
    { name: 'CSG20', class: 'S71', room: 'B-107', day : WeekDay.Qua, slot: Slot.M5 }
  ];
